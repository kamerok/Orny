...
class StatisticsInteractorImpl @Inject constructor(
    ...
    override fun getStatistics(): Observable<Statistics> = Observable
            .combineLatest(
                    pageRepo.getPageSettings().defaultBackgroundSchedulers(),
                    pageRepo.getPageAuthors().defaultBackgroundSchedulers(),
                    expenseRepo.getAllExpenses().defaultBackgroundSchedulers(),
                    Function3 {
